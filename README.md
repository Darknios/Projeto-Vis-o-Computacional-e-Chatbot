...
Este projeto desenvolve um modelo de Visão Computacional capaz de identificar três classes de animais — Cavalo, Vaca e Ovelha — a partir de imagens. Utilizando técnicas de Deep Learning, o sistema realiza todo o fluxo de processamento: organização do dataset, aumento de dados (data augmentation), construção do modelo, treinamento, validação e testes com imagens reais enviadas pelo usuário.
